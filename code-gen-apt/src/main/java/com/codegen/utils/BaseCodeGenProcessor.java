...
import com.codegen.utils.processor.api.GenQueryRequest;
import com.codegen.utils.processor.api.GenQueryRequestProcessor;
import com.codegen.utils.processor.controller.GenController;
import com.codegen.utils.processor.controller.GenControllerProcessor;
import com.codegen.utils.processor.creator.GenCreator;
import com.codegen.utils.processor.creator.GenCreatorProcessor;
import com.codegen.utils.processor.mapper.GenMapper;
import com.codegen.utils.processor.mapper.GenMapperProcessor;
import com.codegen.utils.processor.query.GenQuery;
import com.codegen.utils.processor.query.GenQueryCodeProcessor;
import com.codegen.utils.processor.repository.GenRepository;
import com.codegen.utils.processor.repository.GenRepositoryProcessor;
import com.codegen.utils.processor.update.GenUpdate;
import com.codegen.utils.processor.update.GenUpdateCodeProcessor;
import com.codegen.utils.processor.vo.GenVo;
import com.codegen.utils.processor.vo.VoCodeGenProcessor;
...
public abstract class BaseCodeGenProcessor implements CodeGenProcessor {
    ...
    public DefaultNameContext getNameContext(TypeElement typeElement) {
        ...
        String creatorName = typeElement.getSimpleName() + GenCreatorProcessor.SUFFIX;
        String updateName = typeElement.getSimpleName() + GenUpdateCodeProcessor.SUFFIX;
        String queryName = typeElement.getSimpleName() + GenQueryCodeProcessor.SUFFIX;
        String queryRequestName = typeElement.getSimpleName() + GenQueryRequestProcessor.QUERY_REQUEST_SUFFIX;
        String repositoryName = typeElement.getSimpleName() + GenRepositoryProcessor.SUFFIX;
        ...
        context.setUpdateClassName(updateName);
        ...
        Optional.ofNullable(typeElement.getAnnotation(GenUpdate.class)).ifPresent(anno -> {
